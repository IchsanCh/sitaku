            ...
            <div class="card-body">
                ...
                <div class="space-y-4">
                    ...
                    <div class="collapse collapse-arrow bg-base-200">
                        ...
                        <div class="collapse-content">
                            <p class="mb-4 font-semibold">
                                Buka menu Pengaturan untuk mengisi data unit, token fonnte dan endpoint api untuk pemohon
                                dan pegawai.
                            </p>
                            <div class="alert alert-warning mb-4 font-semibold">
                                ...
                                <span>
                                    ...
                                    <a href="/docs/api/pemohon" class="link link-primary font-semibold">API
                                        Guide</a>
                                </span>
                            </div>
                            <div class="flex gap-2">
                    ...
                    <div class="collapse collapse-arrow bg-base-200">
                        ...
                        <div class="collapse-content">
                            <p class="mb-4 font-semibold">
                                Tambahkan data pegawai dan pastikan seluruh pengaturan telah terisi dengan benar.
                                ...
                                pegawai dan pemohon telah sesuai.
                            </p>
