...
<style>
    ...
    #replyPreview:not([hidden]), #mediaPreview:not([hidden]) { display: block; }
</style>
<div class="max-w-2xl mx-auto px-4 py-6">
    ...
    <div class="card bg-base-100 shadow-xl border border-base-300">
        <div class="card-body p-0">
            ...
            <div id="replyPreview" class="px-4 pt-2 border-t border-base-300 items-center justify-between text-sm" hidden>
            ...
            <div id="mediaPreview" class="px-4 pt-2 border-t border-base-300 items-center justify-between text-sm" hidden>
                <div class="flex items-center justify-between bg-base-200 rounded-lg px-3 py-2">
            ...
            <form id="replyForm" class="p-4 border-t border-base-300 flex gap-2 items-center">
                @csrf
                ...
                <input type="text" name="message" id="messageInput" class="input input-bordered flex-1"
                    placeholder="Tulis balasan..." autocomplete="off" maxlength="2000"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // Swipe-to-reply -- geser bubble pesan ke kanan buat set target reply.
    // Pakai pointer events biar jalan di touch maupun mouse sekaligus.
    function attachSwipeHandler(wrapEl) {
        ...
        function endSwipe() {
            ...
            if (dx >= THRESHOLD) {
                const wrap = wrapEl;
                setReplyTarget(wrap.dataset.msgId, wrap.dataset.senderLabel, wrap.dataset.excerpt);
            }
            dx = 0;
        }
    ...
    function appendMessage(data) {
        ...
        wrap.dataset.senderType = data.sender_type;
