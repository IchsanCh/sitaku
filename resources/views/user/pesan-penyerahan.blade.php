...
@section('meta_description',
    'Atur dan sesuaikan pesan notifikasi untuk penyerahan izin. Gunakan variabel dinamis agar isi pesan
    lebih personal dan relevan.')
@section('og_description',
    'Kelola pesan custom untuk penyerahan izin. Tambahkan variabel dinamis, pratinjau hasilnya,
        ...
        <div class="bg-base-100 borderbc1">
            <div class="max-w-4xl mx-auto px-6 py-8">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-base-content">Pesan Custom Penyerahan Izin</h1>
                    ...
                    <div class="card-body p-8">
                        ...
                        <div class="bg-gradient-to-r from-info/10 to-success/10 border border-info/20 rounded-2xl p-4 mb-6">
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                <span
                                    class="badge badge-primary badge-lg cursor-pointer hover:scale-105 transition-transform"
                                    onclick="insertVariable('{link_izin}')">{link_izin}</span>
                            </div>
                    ...
                    <div class="card-body p-8">
                        ...
                        <div class="mt-4 p-4 bg-info/10 border border-info/20 rounded-xl">
                            ...
                            <div class="text-md space-y-1">
                                ...
                                <div>Link Izin: <strong>https://example.com/izin/REG-2024-001.pdf</strong></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updatePreview() {
                ...
                text = text.replace(/{link_izin}/g, "https://example.com/izin/REG-2024-001.pdf");
