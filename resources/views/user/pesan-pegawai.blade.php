            ...
            <div class="max-w-4xl mx-auto px-6 py-8">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-base-content/70">Configure Custom Message for Pegawai</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body p-8">
                        ...
                        <div class="mt-4 p-4 bg-info/10 border border-info/20 rounded-xl">
                            ...
                            <div class="text-md space-y-1">
                                <div>Nama Pemohon: <strong>Sitaku</strong></div>
                                <div>Nomor Permohonan: <strong>REG-2024-001</strong></div>
                                <div>Tanggal Permohonan: <strong> 2025-07-23 20:31:33</strong></div>
                                ...
                                <div>Nama Pegawai: <strong>Ichsan</strong></div>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function updatePreview() {
                ...
                text = text.replace(/{nama_pemohon}/g, "Sitaku");
                text = text.replace(/{nama_pegawai}/g, "Ichsan");
