...
<head>
    ...
    @vite(['resources/css/exavro-auth.css', 'resources/js/auth.js'])
    <meta property="og:title" content="@yield('title', 'Exavro')">
    <meta name="description" content="@yield('meta_description', 'Masuk atau daftar ke Exavro, sistem notifikasi WhatsApp otomatis untuk pemohon dan pegawai.')">
