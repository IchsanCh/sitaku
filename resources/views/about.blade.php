<x-layout>
    ...
    @section('meta_description',
        'Pelajari lebih lanjut tentang Sitaku, sistem notifikasi otomatis yang mempermudah
        proses komunikasi antara pegawai dan pemohon. Efisien, cepat, dan andal.')
    @section('og_description',
        'Sitaku adalah sistem notifikasi otomatis berbasis WhatsApp yang membantu instansi
