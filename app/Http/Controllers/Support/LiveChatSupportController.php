...
class LiveChatSupportController extends Controller
{
    ...
    public function show(LiveChat $liveChat)
    {
        ...
        // Full load -- semua pesan room ini, urut dari lama ke baru. Pagination
        // udah dicoba tapi kebanyakan bagian bergerak & susah dipastiin bener
        // tanpa browser beneran, jadi ditarik mundur ke versi paling simpel.
